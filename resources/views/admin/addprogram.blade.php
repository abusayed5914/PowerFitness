...
.W_img{margin-top: 10px;}
  ...
  <section id="main">
   ...
   @include('include.error')
             ...
             <h3 class="panel-title text-center">Add Program</h3>
              </div>
              <div class="panel-body">
                ...
                <div class="col-md-12">
                  <div class="W_name">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="Program Title">
                  </div>
                </div>
                  ...
                  <div class="W_cat" >
                    ...
                    <select name="category" id="" class="form-control" placeholder="Select Catagory" >  
                      @foreach($programCategories as $category)
                        <option value="{{$category->id}}">{{$category->program_category_name}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
