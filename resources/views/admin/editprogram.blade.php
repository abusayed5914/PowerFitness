        ...
        @include('admin.include.rightsidebar')
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
             ...
             <h3 class="panel-title text-center">Update Program</h3>
              </div>
              <div class="panel-body">
                <form action="/updateprogram" method="POST" enctype="multipart/form-data">
                <div class="col-md-12">
                  <div class="W_name">
            ...
            <textarea class="form-control"  name="details" id="FormControl" rows="3" placeholder="Workout Description"> {{ old('details', $workout->description) }}</textarea>
                  </div>
                </div>
                  ...
                  <div class="W_cat" >
                    ...
                    <select name="category" id="" class="form-control" placeholder="Select Catagory" >  
                      @foreach($programCategories as $programCategory)
                        <option value="{{$programCategory->id}}" {{ ( $workout->category == $programCategory->id ) ? 'selected' : '' }}>{{$programCategory->program_category_name}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
