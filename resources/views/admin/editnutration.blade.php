...
.W_img{margin-top: 10px;}
  ...
  <section id="main">
   ...
   @include('include.error')
             ...
             <h3 class="panel-title text-center">Update Nutration</h3>
              </div>
              ...
              <div id="seven-days-description"  style="
                ...
                <!-- image field for protein -->
                 <div class="col-md-12">
                  <div class="W_img">
                    <img src="{{url('/file/'.$nutration->nutration_image)}}" class="img-responsive" alt="" style="height: 200px;width: 300px; display: block;margin-left: auto;margin-right: auto;">
                  </div>
                </div>
