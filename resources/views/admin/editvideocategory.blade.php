        ...
        @include('admin.include.rightsidebar')
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
             ...
             <h3 class="panel-title text-center">Update Video Category</h3>
              </div>
              <div class="panel-body">
                <form action="/updatevideocategory" method="POST" enctype="multipart/form-data">
                <div class="col-md-12">
                  <div class="W_name">
                    <label for="FormControl">Title</label>
                    <input type="hidden" name="id" class="form-control" placeholder="Workout Name" value="{{ $workout->id }}">

                    <input type="text" name="name" class="form-control" placeholder="Workout Name" value="{{ old('name', $workout->video_category_name) }}">
                  </div>
                </div>
