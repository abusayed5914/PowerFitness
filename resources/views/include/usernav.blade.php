    ...
    <!-- Navbar -->
        ...
        <div class="collapse navbar-collapse navbar-right" id="myNavbar" style=" font-family:Roboto;margin-right:70px">
                   
               <a href="/"><img src="img/logo.jpg" alt="" style="height:70px;width:180px;float:left; margin-right:40px" > </a>  
            <ul class="nav navbar-nav">
                <li><a href="/" class="{{ Request::is('/') ? "active" : ""}}">Home</a></li>          
                <li class="dropdown"> 
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" >Workout<span class="caret"></span></a>
        ...
        <li class="dropdown"> 
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" >Videos <span class="caret"></span></a>
            <ul class="dropdown-menu">
                ...
                <li><a href="{{ URL::route('contactpage') }}" >Contact</a></li>
                @if(Auth::check())
                   <li class="dropdown"> 
                     <a href="#" class="dropdown-toggle" data-toggle="dropdown" >{{Auth::user()->name}}<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            ...
                            @endif
                              ...
                              <li><a href="/mynutrationplan">My Nutrition Plan</a></li>
                              <li>
                                        <a href="{{ route('logout') }}"
